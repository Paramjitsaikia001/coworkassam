...
function Navbar() {
    ...
    return (
        <nav className="flex flex-wrap justify-between items-start px-6 md:px-12 py-4 h-20 w-full sticky top-0 z-50 bg-white">
            <NavLink to="/">
            ...
            <NavLink
            to="/booktour"
            className="p-1 md:p-2 bg-[#00ff62] rounded-[5px] shadow-[1px_5px_0px_0px_#000] transition-all duration-300"
            >
            Connect
            </NavLink>
            </div>
